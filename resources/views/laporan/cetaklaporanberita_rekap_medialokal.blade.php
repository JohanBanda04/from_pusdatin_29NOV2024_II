...
<section class="sheet padding-10mm">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td>
                <center>
                    <span id="title">
                    REKAPITULASI PUBLIKASI MEDIAz LOKAL KEMENKUMHAM NTB  <br>
    ...
    <table class="tabelpresensi " style="border-spacing: 0px;
        ...
        <tr>
            ...
            <th rowspan="1" colspan="3">Satuan Kerjaz</th>
            <th rowspan="1" colspan="3" style="width: max-content">Link Media Lokals</th>
        ...
        <tr style="background: rgba(205,178,184,0.43); font-weight: bold">
            <td colspan="4" align="center">Jumlahs</td>
            <td colspan="3" align="center">{{ $total_medlokal_perberita_akhirs }}</td>
        </tr>
