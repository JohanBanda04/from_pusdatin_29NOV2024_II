    ...
    <table class="tabelpresensi" style="border-spacing: 0px;
        ...
        $tahun = $exp_tgl_input[0];
                    ...
                    <td>
                        ...
                        //echo explode("|||",$link_lokal)[0];
                        //echo "<br>";
                        //echo "<pre>"; print_r($link_lokal);
                        if(explode("|||",$link_lokal)[0]=="no media"){
                            $complete_data = "no media"."|||".$explode[1]."|||".$explode[2];
                        } else if(explode("|||",$link_lokal)[0]!="no media"){
                ...
                <tr>
                    ...
                    <td align="center" valign="center" style="font-weight: bold; font-size: 15px; background: #eceaea">
                        ...
                        @foreach($links_media_lokal as $ml)
                            @if(strlen($ml)>10)
                                @php
                                    $explode_getmedianame = explode("|||",$ml)[0];
                                    $explode_gettittle = explode("|||",$ml)[1];
                                    //echo "length: ".strlen($explode_gettittle)."<br>";
                                    //echo "get title :".$explode_gettittle."<br>";
